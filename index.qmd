...
```
::: {.notes}
- Sieht erstmal wie zwei verschiedene Duiagramme aus: hier täuscht die Skala auf der Y-Achse! Passen wir die also an, ...
:::
...
::: {.notes}
- Beeswarm zeigt das deutliochste Bild
...
::: {.notes}
- Violinendiagramme, eine abwandlung der Boxplots soll Verteilungen besser darstellen, aber : Vorsicht bei kleinen Stichproben! Weil...
:::
