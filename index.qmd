---
title: "Torten 🍰, Kerzen 🕯️, <br>Violinen 🎻 und Wälder 🌳"
lang: de
execute:
  echo: false
nocite: |
  @Holtz, @Siirtola2019, @Few2007, @Nussbaumer2011, @Weissgerber2015
---
...
lollipops <- armsData[1:20, ] %>%
  ...
  geom_point(size = 4, color = palette.colors(palette = "Okabe-Ito")[1]) +
  theme_classic() +
  theme(
...
treemap <- armsData[1:20, ] %>%
  ...
  scale_fill_manual(values = rep(palette.colors(palette = "Okabe-Ito"), 20))
